...
//
//    public LongChecker(String symbol, PeriodTypeEnum opPeriodType, Map<PeriodTypeEnum, List<Candlestick>> periodTypeCandlesticksMap) {
...
//                && candlestick0.getClose().compareTo(MathUtil.min(candlestick1==null?null:candlestick1.getHigh(), candlestick2==null?null:candlestick2.getHigh())) > 0) {
//            return true;
//        }
//        return false;
//    }
...
//
//                && candlestick0.getClose().compareTo(MathUtil.max(candlestick1.getLow(), candlestick2.getLow()))> 0
//
...
//                    && candlestick0.getChangeRate().compareTo(periodTypeEnum.getCrossRateThreshold()) > 0
...
//                && candlestick2.getClose().compareTo(candlestick2.getOpen()) < 0
//                && candlestick1.getClose().compareTo(candlestick2.getHigh()) > 0
//                && candlestick1.getChangeRate().compareTo(periodTypeEnum.getCrossRateThreshold()) > 0
//                && checkOverResistanceTrend(GlobalConstants.FIRST_OP_PERIOD)) {
//            return true;
//        }
//
...
//
//        Pair<String, BigDecimal> minHighPair = Pair.of("H1", MathUtil.min(trendCandlestick1==null?null:trendCandlestick1.getHigh(), trendCandlestick2==null?null:trendCandlestick2.getHigh()));
//        Pair<String, BigDecimal> maxHighPair = Pair.of("H2", MathUtil.max(trendCandlestick1==null?null:trendCandlestick1.getHigh(), trendCandlestick2==null?null:trendCandlestick2.getHigh()));
//
