...
//
//@Slf4j
//public class LongChecker2 extends Checker {
//
//    String checkMessage = "";
//    String changeRateMessage = "";
//
//    public LongChecker2(String symbol, Map<PeriodTypeEnum, List<Candlestick>> periodTypeCandlesticksMap) {
...
//        Candlestick candlestick2 = getLastCandlestick(periodTypeEnum, -2);
//
//        BigDecimal minHigh = MathUtil.min(candlestick1==null?null:candlestick1.getHigh(), candlestick2==null?null:candlestick2.getHigh());
//        BigDecimal maxHigh = MathUtil.max(candlestick1==null?null:candlestick1.getHigh(), candlestick2==null?null:candlestick2.getHigh());
//
//        if (minHigh != null
//                && candlestick0.getClose().compareTo(candlestick0.getOpen()) > 0
//                && candlestick0.getClose().compareTo(minHigh) > 0
//
//                && min30Candlestick1.getClose().compareTo(minHigh) <= 0
//                && min30Candlestick0.getClose().compareTo(min30Candlestick0.getOpen()) > 0) {
//
//            return Pair.of(true, minHigh);
//        }
//
//        if (maxHigh != null
//                && candlestick0.getClose().compareTo(candlestick0.getOpen()) > 0
//                && candlestick0.getClose().compareTo(maxHigh) > 0
//
//                && min30Candlestick1.getClose().compareTo(maxHigh) <= 0
//                && min30Candlestick0.getClose().compareTo(min30Candlestick0.getOpen()) > 0) {
//
