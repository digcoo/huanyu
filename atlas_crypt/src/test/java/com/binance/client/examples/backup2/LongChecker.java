...
//
//@Slf4j
//public class LongChecker extends Checker {
//
//    public LongChecker(String symbol, Map<PeriodTypeEnum, List<Candlestick>> periodTypeCandlesticksMap) {
//        super(symbol, periodTypeCandlesticksMap);
//    }
//
//    @Override
//    SideTypeEnum getSide() {
//        return SideTypeEnum.LONG;
//    }
//
...
//
//        BigDecimal maxHigh = MathUtil.max(opCandlestick1 == null ? null : opCandlestick1.getHigh(), opCandlestick2 == null ? null : opCandlestick2.getHigh());
//
//        if (opCandlestick2 != null
//                && opCandlestick1.getClose().compareTo(opCandlestick1.getOpen()) < 0
//                && opCandlestick0.getClose().compareTo(maxHigh) > 0) {
//            return Pair.of(true, "(" + maxHigh + ")");
//        }
//
...
//
//
//        BigDecimal minHigh = MathUtil.min(keyCandlestick1 == null ? null : keyCandlestick1.getHigh(), keyCandlestick2 == null ? null : keyCandlestick2.getHigh());
//        BigDecimal maxHigh = MathUtil.max(keyCandlestick1 == null ? null : keyCandlestick1.getHigh(), keyCandlestick2 == null ? null : keyCandlestick2.getHigh());
//
//        BigDecimal maxHighWindowValue = maxHigh == null? null : BigDecimal.ONE.add(keyPeriodType.getCrossRateThreshold()).multiply(maxHigh);
//        BigDecimal minHighWindowValue = maxHigh == null? null : BigDecimal.ONE.add(keyPeriodType.getCrossRateThreshold()).multiply(minHigh);
//
//        if (minHigh != null && opCandlestick1 != null
//                && opCandlestick0.getClose().compareTo(minHigh) > 0
//                && opCandlestick1.getClose().compareTo(minHigh) <= 0) {
//
...
//        }
//
//        if (maxHigh != null && opCandlestick1 != null
//                && opCandlestick0.getClose().compareTo(maxHigh) > 0
//                && opCandlestick1.getClose().compareTo(maxHigh) <= 0) {
//
//            return CheckResponse.builder()
//                    .success(true)
//                    .message("(" + maxHigh + ")")
...
//            if (opCandlestick0.getClose().compareTo(BigDecimal.ONE.add(new BigDecimal("0.01")).multiply(opCandlestick1.getLow())) < 0) {
//                return false;
//            }
//        }
//
...
//
//                && opCandlestick0.getHigh().compareTo(opCandlestick1.getHigh()) > 0
//
...
//                .message("今凹-"+opCandlestick1.getHigh())
//                .build();
//        }
//
//        //凹2
...
//
//                //今日
//                && opCandlestick0.getClose().compareTo(MathUtil.min(opCandlestick1.getHigh(), opCandlestick2.getHigh())) > 0
//
//                && opCandlestick1.getClose().compareTo(MathUtil.min(opCandlestick2.getHigh(), opCandlestick3.getHigh())) <= 0
//
//        ) {
//            return CheckResponse.builder()
//                    .success(true)
//                    .periodType(opPeriodType)
//                    .message("凹2"+MathUtil.min(opCandlestick1.getHigh(), opCandlestick2.getHigh()))
//                    .build();
//        }
//
//        return CheckResponse.builder()
...
////                    && opCandlestick0.getClose().compareTo(opCandlestick0.getOpen()) > 0
//                    && MathUtil.min(opCandlestick1.getClose(), opCandlestick0.getLow()).doubleValue() <= latestGoldMACDPoint.getTicker().getHigh()
//            ) {
//                String tickerMessage = "(" + latestGoldMACDPoint.getTicker().getTimestampStr() + ":" + latestGoldMACDPoint.getTicker().getHigh() + ")";
//                return CheckResponse.builder()
//                        .success(true)
...
////                    && opCandlestick0.getClose().compareTo(opCandlestick0.getOpen()) > 0
//                    && MathUtil.min(opCandlestick1.getClose(), opCandlestick0.getLow()).doubleValue() <= latestGoldMACDPoint.getTicker().getLow()
//            ) {
//                String tickerMessage = "(" + latestGoldMACDPoint.getTicker().getTimestampStr() + ":" + latestGoldMACDPoint.getTicker().getLow() + ")";
//                return CheckResponse.builder()
//                        .success(true)
...
////                    && opCandlestick0.getLow().doubleValue() <= latestGreenGoldMACDPoint.getTicker().getHigh()
////            ) {
...
////                    && opCandlestick0.getLow().doubleValue() <= latestGreenGoldMACDPoint.getTicker().getLow()
////            ) {
...
////                    && opCandlestick0.getLow().doubleValue() <= latestRedGoldMACDPoint.getTicker().getHigh()
////            ) {
...
////                    && opCandlestick0.getLow().doubleValue() <= latestRedGoldMACDPoint.getTicker().getLow()
////            ) {
...
////            //箱顶启动
////            if (opCandlestick0.getClose().doubleValue() > latestGoldMACDPoint.getTicker().getHigh()
////                    && opCandlestick1.getClose().doubleValue() <= latestGoldMACDPoint.getTicker().getHigh()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("MACD黄金ticker--箱顶启动")
////                        .build();
////            }
////
////            //箱顶下探
...
////
////                    && opCandlestick1.getClose().doubleValue() > latestGoldMACDPoint.getTicker().getHigh()
////                    && opCandlestick0.getLow().doubleValue() <= latestGoldMACDPoint.getTicker().getHigh()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("MACD黄金ticker--箱顶下探")
////                        .build();
////            }
////
////            //箱底启动
////            if (opCandlestick0.getClose().doubleValue() > latestGoldMACDPoint.getTicker().getLow()
////                    && opCandlestick1.getClose().doubleValue() <= latestGoldMACDPoint.getTicker().getLow()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("MACD黄金ticker--箱底启动")
////                        .build();
////            }
////
////            //箱体下探
...
////                    && opCandlestick0.getClose().compareTo(MathUtil.max(opCandlestick1.getLow(), opCandlestick2.getLow() )) > 0
////                    && opCandlestick1.getClose().doubleValue() > latestGoldMACDPoint.getTicker().getLow()
////                    && opCandlestick0.getLow().doubleValue() <= latestGoldMACDPoint.getTicker().getLow()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("MACD黄金ticker--箱底下探")
////                        .build();
////            }
////
////
...
////
////        //KDJ黄金交叉位
////        List<KDJIndicator.KDJPoint> kdjPoints = KDJIndicator.calculateKDJ(Ticker.from(lastCandlesticks));
////        KDJIndicator.KDJPoint latestGoldKDJPoint = KDJIndicator.getLatestGoldKDJPoint(kdjPoints);
////
////
////        if(latestGoldKDJPoint != null) {
////
////
////            //箱顶启动
////            if (opCandlestick0.getClose().doubleValue() > latestGoldKDJPoint.getTicker().getHigh()
////                    && opCandlestick1.getClose().doubleValue() <= latestGoldKDJPoint.getTicker().getHigh()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("KDJ黄金ticker--箱顶启动")
////                        .build();
////            }
////
////            //箱顶下探
...
////                    && opCandlestick1.getClose().doubleValue() > latestGoldMACDPoint.getTicker().getHigh()
////
////                    && opCandlestick0.getLow().doubleValue() <= latestGoldKDJPoint.getTicker().getHigh()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("KDJ黄金ticker--箱顶下探")
////                        .build();
////            }
////
////            //箱底启动
////            if (opCandlestick0.getClose().doubleValue() > latestGoldKDJPoint.getTicker().getLow()
////                    && opCandlestick1.getClose().doubleValue() <= latestGoldKDJPoint.getTicker().getLow()
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("KDJ黄金ticker--箱底启动")
////                        .build();
////            }
////
////            //箱底下探
...
////                    && opCandlestick1.getClose().doubleValue() > latestGoldMACDPoint.getTicker().getLow()
////
////                    && opCandlestick0.getLow().doubleValue() <= latestGoldKDJPoint.getTicker().getLow()
////
////            ) {
////                return CheckResponse.builder()
////                        .success(true)
////                        .periodType(trendPeriodType)
////                        .message("KDJ黄金ticker--箱底下探")
////                        .build();
////            }
////
////
