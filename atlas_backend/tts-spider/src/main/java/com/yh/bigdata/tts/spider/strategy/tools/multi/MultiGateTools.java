 ...
 * 多周期强势 v1.0 · Gate
 */
public final class MultiGateTools {

    private MultiGateTools() {
    }

    public static boolean passGate(StockBase stock, CheckResult checkResult, MultiStrategyParams params) {
        if (stock == null) {
            return false;
        }
