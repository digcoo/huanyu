...
public final class CascadeWaveDayEvaluator {



    private CascadeWaveDayEvaluator() {

    }



    public static CascadeWaveDayEvaluation evaluate(StockBase stock, CheckResult checkResult,
        ...
        if (!WaveShapeOptionalGateTools.passGate(stock, checkResult, enableAllYangGate, enableMin30Gate,
            ...
            return CascadeWaveDayEvaluation.miss();
        }
        ...
        if (enableDay) {
            ...
            dayHit = CascadeWaveBreakoutTools.findDayEdgeTierHit(stock, PeriodTypeEnum.DAY, lookbackDay,
        ...
        if (enableWeek) {
            ...
            weekHit = CascadeWaveBreakoutTools.findDayEdgeTierHit(stock, PeriodTypeEnum.WEEK, lookbackWeek,
        ...
        if (enableMonth) {
            ...
            monthHit = CascadeWaveBreakoutTools.findDayEdgeTierHit(stock, PeriodTypeEnum.MONTH, lookbackMonth,
        ...
        return new CascadeWaveDayEvaluation(dayHit, weekHit, monthHit, true);
    ...
    public static final class CascadeWaveDayEvaluation {
        ...
        CascadeWaveDayEvaluation(CascadeWaveBreakoutTools.TierHit dayHit,
        ...
        static CascadeWaveDayEvaluation miss() {

            return new CascadeWaveDayEvaluation(null, null, null, false);
