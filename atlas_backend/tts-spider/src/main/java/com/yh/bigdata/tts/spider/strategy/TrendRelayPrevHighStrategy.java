...
import com.yh.bigdata.tts.spider.strategy.tools.trendrelayprevhigh.TrendRelayPrevHighEvaluator;

import com.yh.bigdata.tts.spider.strategy.tools.trendrelayprevhigh.TrendRelayPrevHighTools;
...
public class TrendRelayPrevHighStrategy extends AbstractStrategy {
    ...
    public StrategyTypeEnum getStrategy() {
        ...
        return StrategyTypeEnum.TREND_RELAY_PREV_HIGH;
    ...
    public CheckResult check(StockBase stockBase, List<PeriodTypeEnum> trendPeriodTypes,
        ...
        try {
            ...
            TrendRelayPrevHighStrategyParams params = resolveParams(queryContextParam);

            TrendRelayPrevHighEvaluator.TrendRelayPrevHighEvaluation eval =

                    TrendRelayPrevHighEvaluator.evaluate(stockBase, checkResult, params);
            ...
            PeriodTypeEnum primary = eval.getPeriod() != null
                    ...
                    : TrendRelayPrevHighTools.resolvePeriod(params.getTier());
    ...
    private TrendRelayPrevHighStrategyParams resolveParams(QueryContextParam queryContextParam) {

        if (queryContextParam == null || queryContextParam.getTrendRelayPrevHigh() == null) {

            return TrendRelayPrevHighStrategyParams.defaults();

        }

        return TrendRelayPrevHighStrategyParams.merge(queryContextParam.getTrendRelayPrevHigh());
