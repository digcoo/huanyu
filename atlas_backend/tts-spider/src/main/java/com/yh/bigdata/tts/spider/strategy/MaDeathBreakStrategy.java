...
@Slf4j
@Component
public class MaDeathBreakStrategy extends AbstractStrategy {

    @Override
    public StrategyTypeEnum getStrategy() {
        return StrategyTypeEnum.MA_DEATH_BREAK;
    }
    ...
    public CheckResult check(StockBase stockBase, List<PeriodTypeEnum> trendPeriodTypes,
        ...
        try {
            ...
            MaCrossPointEvaluator.MaCrossPointEvaluation eval =
                    MaCrossPointEvaluator.evaluate(stockBase, checkResult, params, MaCrossPointCore.CrossKind.DEATH);
            if (!eval.isHit()) {
                return checkResult;
            }
    ...
    private MaCrossPointStrategyParams resolveParams(QueryContextParam queryContextParam) {
        if (queryContextParam == null || queryContextParam.getMaDeathBreak() == null) {
            return MaCrossPointStrategyParams.defaults();
        }
        return MaCrossPointStrategyParams.merge(queryContextParam.getMaDeathBreak());
    }
