...
public final class CascadeWaveConvexMarkersTools {
    ...
    private CascadeWaveConvexMarkersTools() {
    }
        ...
        switch (period) {
            case WEEK:
                ...
                return CascadeWaveBreakoutTools.findTierHit(stock, PeriodTypeEnum.WEEK, p.getLookbackWeek(),
                        com.yh.bigdata.tts.spider.strategy.tools.wavecc.WaveShapeTools.BandShape.CONVEX,
                        p.isEnablePrevBandBreak());
            case MONTH:
                if (!p.isEnableMonth()) {
                    return null;
                }
