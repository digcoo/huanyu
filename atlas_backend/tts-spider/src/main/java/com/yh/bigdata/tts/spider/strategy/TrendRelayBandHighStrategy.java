...
import com.yh.bigdata.tts.spider.strategy.tools.trendrelaybandhigh.TrendRelayBandHighEvaluator;

import com.yh.bigdata.tts.spider.strategy.tools.trendrelaybandhigh.TrendRelayBandHighTools;
...
public class TrendRelayBandHighStrategy extends AbstractStrategy {
    ...
    public StrategyTypeEnum getStrategy() {
        ...
        return StrategyTypeEnum.TREND_RELAY_BAND_HIGH;
    ...
    public CheckResult check(StockBase stockBase, List<PeriodTypeEnum> trendPeriodTypes,
        ...
        try {
            ...
            TrendRelayBandHighStrategyParams params = resolveParams(queryContextParam);

            TrendRelayBandHighEvaluator.TrendRelayBandHighEvaluation eval =

                    TrendRelayBandHighEvaluator.evaluate(stockBase, checkResult, params);
            ...
            PeriodTypeEnum primary = eval.getPeriod() != null
                    ...
                    : TrendRelayBandHighTools.resolvePeriod(params.getTier());
    ...
    private TrendRelayBandHighStrategyParams resolveParams(QueryContextParam queryContextParam) {

        if (queryContextParam == null || queryContextParam.getTrendRelayBandHigh() == null) {

            return TrendRelayBandHighStrategyParams.defaults();

        }

        return TrendRelayBandHighStrategyParams.merge(queryContextParam.getTrendRelayBandHigh());
