...
public class WeekMin60ComboToolsTest {
    ...
    public void passesWeekCloseAboveRecentLows() {
        ...
        Assert.assertTrue(WeekMin60ComboTools.passesWeekCloseAboveRecentLows(weeks));
        weeks.get(2).setClose(1.96);
        Assert.assertFalse(WeekMin60ComboTools.passesWeekCloseAboveRecentLows(weeks));
    }

    @Test
    public void hitsWhenMin60BreaksBandHighInLastWeekWithAmplitudeExpand() {
        ...
        List<MACDIndicatorUtils.MACDPoint> points = points(trades,
                ...
                true, false,
                0.5, false);
        WeekMin60ComboTools.Hit hit = WeekMin60ComboTools.findHitOnBars(
                trades, points, WeekMin60ComboStrategyParams.builder()
                        .prevWeeks(0)
                        .maxBarsPerWeek(20)
                        .gcLookbackBars(20)
    ...
    public void rejectsWhenAmplitudeNotExpand() {
        List<Trade> trades = buildMin60SeriesForReject();
        List<MACDIndicatorUtils.MACDPoint> points = points(trades,
                false, false,
                false, false,
                false, false,
                ...
                false, false,
                0.5, false);
        Assert.assertNull(WeekMin60ComboTools.findHitOnBars(
                trades, points, WeekMin60ComboStrategyParams.builder()
                        .prevWeeks(0)
                        .maxBarsPerWeek(20)
                        .gcLookbackBars(20)
    ...
    public void passesAmplitudeExpand() {
        ...
        Assert.assertTrue(WeekMin60ComboTools.passesAmplitudeExpand(sig, prev));
    }
    ...
    private static List<Trade> buildMin60Series() {
        return Arrays.asList(
                ...
                bar("2026-07-17", 11.0, 11.05, 11.05, 11.0),
                bar("2026-07-18", 13.05, 13.08, 13.12, 13.04));
    }

    private static List<Trade> buildMin60SeriesForReject() {
        return Arrays.asList(
                bar("2026-07-14", 10, 11, 11.5, 10),
                bar("2026-07-15", 11, 12, 12.5, 11),
                bar("2026-07-16", 12, 11.5, 13, 11),
