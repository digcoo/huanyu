...
public class BottomBandHighToolsTest {



    @Test

    public void findHitOnBars_firstBreakBandHigh() {
        ...
        BottomBandHighTools.Hit hit = BottomBandHighTools.findHitOnBars(bars, PeriodTypeEnum.DAY, 20);
    ...
    public void findHitOnBars_stillHitWhenRetestLowInWindow() {
        ...
        Assert.assertNotNull(BottomBandHighTools.findHitOnBars(bars, PeriodTypeEnum.DAY, 20));
    ...
    public void findHitOnBars_missWhenPriorCloseAboveBandHigh() {
        ...
        Assert.assertNull(BottomBandHighTools.findHitOnBars(bars, PeriodTypeEnum.DAY, 20));
