...
public class TrendRelay2YangToolsTest {

    @Test
    public void findHitOnBars_noRetestLastTwoYangCloseAboveBandLow() {
        List<Trade> bars = Arrays.asList(
                yang("2026-01-01", 10.0, 11.0, 9.5, 10.8),
                yin("2026-01-02", 10.8, 10.5, 11.0, 10.4),
                yin("2026-01-03", 10.5, 10.6, 10.0, 10.45),
                yang("2026-01-04", 10.5, 10.9, 10.2, 10.7),
                yang("2026-01-05", 10.7, 11.0, 10.4, 10.9)
        );
        TrendRelay2YangTools.Hit hit = TrendRelay2YangTools.findHitOnBars(bars, PeriodTypeEnum.DAY, 20);
    ...
    @Test
    public void findHitOnBars_missWhenExtraYangBeforeLastTwo() {
        List<Trade> bars = Arrays.asList(
                yang("2026-01-01", 10.0, 11.0, 9.5, 10.8),
                yin("2026-01-02", 10.8, 10.5, 11.0, 10.4),
        ...
        Assert.assertNull(TrendRelay2YangTools.findHitOnBars(bars, PeriodTypeEnum.DAY, 20));
    }

    @Test
    public void findHitOnBars_missWhenThirdLastNotYin() {
        List<Trade> bars = Arrays.asList(
                yang("2026-01-01", 10.0, 11.0, 9.5, 10.8),
                yin("2026-01-02", 10.8, 10.5, 11.0, 10.4),
                yang("2026-01-03", 10.3, 10.6, 10.0, 10.5),
    ...
    public void findHitOnBars_missWhenCloseAboveBandHigh() {
        List<Trade> bars = Arrays.asList(
                ...
                yang("2026-01-03", 10.3, 10.6, 10.0, 10.5),
                yang("2026-01-04", 10.5, 10.9, 10.2, 10.7),
                yang("2026-01-05", 10.7, 11.5, 10.4, 11.2)
        );
        Assert.assertNull(TrendRelay2YangTools.findHitOnBars(bars, PeriodTypeEnum.DAY, 20));
    }
