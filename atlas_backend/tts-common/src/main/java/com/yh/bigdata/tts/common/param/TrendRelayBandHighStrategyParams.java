 ...
 * 趋势中转突破末波段 High（trendrelaybandhigh）：MACD&gt;0 + 未回踩 bandLow + 末 K 首次边沿突破 bandHigh。
...
public class TrendRelayBandHighStrategyParams {
    ...
    public static TrendRelayBandHighStrategyParams defaults() {

        return TrendRelayBandHighStrategyParams.builder().build();

    }



    public static TrendRelayBandHighStrategyParams merge(TrendRelayBandHighStrategyParams incoming) {
        ...
        TrendRelayBandHighStrategyParams d = defaults();
