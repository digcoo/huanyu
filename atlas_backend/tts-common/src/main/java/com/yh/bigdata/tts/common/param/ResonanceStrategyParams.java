...
/**
 * 周期共振策略（reson）可自定义参数 · v1.0
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ResonanceStrategyParams {
    ...
    public static ResonanceStrategyParams defaults() {
        return ResonanceStrategyParams.builder().build();
    }

    public static ResonanceStrategyParams merge(ResonanceStrategyParams incoming) {
        if (incoming == null) {
            return defaults();
        }
        ResonanceStrategyParams d = defaults();
