...
@NoArgsConstructor
@AllArgsConstructor
public class MacdGcWaveHighStrategyParams {
    ...
    public static MacdGcWaveHighStrategyParams defaults() {
        return MacdGcWaveHighStrategyParams.builder().build();
    }

    public static MacdGcWaveHighStrategyParams merge(MacdGcWaveHighStrategyParams incoming) {
        if (incoming == null) {
            return defaults();
        }
        MacdGcWaveHighStrategyParams d = defaults();
