...
public class CascadeWaveConvexDayStrategyParams {
    ...
    public static CascadeWaveConvexDayStrategyParams defaults() {

        return CascadeWaveConvexDayStrategyParams.builder().build();

    }



    public static CascadeWaveConvexDayStrategyParams merge(CascadeWaveConvexDayStrategyParams incoming) {
        ...
        CascadeWaveConvexDayStrategyParams d = defaults();
