...
@NoArgsConstructor
@AllArgsConstructor
public class MacdGcWaveHighLiftStrategyParams {
    ...
    public static MacdGcWaveHighLiftStrategyParams merge(MacdGcWaveHighLiftStrategyParams incoming) {
        if (incoming == null) {
            return defaults();
        }
        MacdGcWaveHighLiftStrategyParams d = defaults();
