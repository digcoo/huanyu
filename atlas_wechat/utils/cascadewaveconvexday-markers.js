...
function shouldShow(id, period) {
  if (adapter.normalizeStrategyId(id) !== 'cascadewaveconvexday') return false;
...
function fetchOverlayForItem(item, id, period) {
  ...
  return stockApi.fetchCascadewaveconvexdayMarkers(item.code, period)
    .then(function (vo) {
...
function enrichItemsWithCascadewaveconvexdayMarkers(items, strategyId, period) {
...
function shouldShowCascadewaveconvexdayMarkers(id, period) {
  return shouldShow(id, period);
}

module.exports = {
  shouldShowCascadewaveconvexdayMarkers: shouldShowCascadewaveconvexdayMarkers,
  resolveOverlayForItem: resolveOverlayForItem,
  resolveBarMarkersForItem: resolveBarMarkersForItem,
  enrichItemsWithCascadewaveconvexdayMarkers: enrichItemsWithCascadewaveconvexdayMarkers,
